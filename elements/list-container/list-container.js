    ...
    Polymer('list-container', {
        ...
        ready: function() {
          ...
          var data = [
                ...
                {
                    "name": "Web Components Weekly #32",
                    "id": "22a57fc805"
                },
                {
                    "name": "Web Components Weekly #33",
                    "id": "64f9d53660"
                },
                {
                    "name": "Web Components Weekly #34",
                    "id": "ce05f6b2ea"
                },
                {
                    "name": "Web Components Weekly #35",
                    "id": "e4bc333ad7"
                },
                {
                    "name": "Web Components Weekly #36",
                    "id": "c1efbdb61a"
                },
                {
                    "name": "Web Components Weekly #37",
                    "id": "88a264dc54"
                },
                {
                    "name": "Web Components Weekly #38",
                    "id": "9f60126ea3"
                },
                {
                    "name": "Web Components Weekly #39",
                    "id": "9f1c34c17a"
                },
                {
                    "name": "Web Components Weekly #40",
                    "id": "c1960e0cf3"
                },
                {
                    "name": "Web Components Weekly #41",
                    "id": "1ea70af0a8"
                },
                {
                    "name": "Web Components Weekly #42",
                    "id": "03dbacc5fd"
                },
                {
                    "name": "Web Components Weekly #43",
                    "id": "59b29fd160"
                }
            ];
